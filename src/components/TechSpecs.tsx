        ...
        <section id="technology" className="py-24 bg-[#0a0a0a] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="mb-16">
                    ...
                    >
                        Engineering <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-brand-teal">Excellence</span>
                    </motion.h2>
                    <div className="h-1 w-24 bg-gradient-to-r from-brand-cyan to-brand-teal" />
                </div>
                    ...
                    {specs.map((spec, index) => (
                        ...
                        >
                            <div className="flex justify-between items-start mb-6">
                                <spec.icon className="w-8 h-8 text-gray-500 group-hover:text-brand-teal transition-colors" />
