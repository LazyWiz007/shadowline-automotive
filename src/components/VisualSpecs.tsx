            ...
            <div className="relative z-10 lg:hidden px-6 pb-24 grid grid-cols-1 gap-12 max-w-2xl mx-auto pt-[40vh]">
                {[...specsLeft, ...specsRight, ...specsBottom].map((spec, i) => (
                    <motion.div
                        ...
                        className="text-left bg-black/50 p-6 backdrop-blur-sm border-l-2 border-white/20 group cursor-pointer"
                    >
                        <h4 className="text-white font-brand font-bold uppercase tracking-widest text-sm mb-2 group-hover:[text-shadow:0_0_10px_rgba(255,255,255,1)]">{spec.label}</h4>
