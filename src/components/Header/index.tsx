            ...
            >
                <div className="flex items-center justify-between w-full pointer-events-auto">
                    ...
                    <div className="flex items-center gap-4 md:gap-8 pointer-events-auto">
                        <button
                            onClick={openModal}
                            className="bg-white text-black text-xs md:text-base font-medium tracking-widest border border-white px-4 py-2 md:px-6 md:py-2 uppercase font-sans hover:bg-black hover:text-white transition-all duration-300"
                        >
                            Book Now
                        </button>
                        ...
                        <div className="flex flex-col lg:flex-row items-end lg:items-end justify-between w-full h-full pb-12 mt-12 md:mt-20 overflow-y-auto">
                            ...
                            <div className="flex flex-col space-y-1 sm:space-y-0 group w-full lg:w-auto">
                                ...
                                <button
                                    ...
                                    className="md:hidden mt-6 text-2xl sm:text-4xl font-bold text-white uppercase tracking-tighter text-left hover:text-gray-400 transition-colors font-brand"
                                >
                                    Book Now
                                </button>
                            </div>
