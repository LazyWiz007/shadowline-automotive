    ...
    <section className="relative min-h-screen flex items-center bg-zinc-950 py-24 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-justify text-lg md:text-xl text-gray-300 leading-relaxed font-light">
          ...
          <p className="text-justify text-base md:text-lg text-gray-400 leading-relaxed">
